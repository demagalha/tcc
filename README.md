...
A seguir, um exemplo da solução ao longo do tempo de uma viga em L, restrição volumétrica 0,4 do volume total, e com força unitária na extremidade direita. O parâmetro de ordem, c, que indica a presença de fases distintas, agora representa quando próximo de 0 o vazio (sem material) e 1 a presença de material.
